...
import com.ird.faa.service.chercheur.facade.VehiculeChercheurService;
...
import com.ird.faa.service.chercheur.facade.GerantChercheurService;
...
@Service
public class EcoleChercheurServiceImpl extends AbstractServiceImpl<Ecole> implements EcoleChercheurService {

    @Autowired
    private EcoleDao ecoleDao;

    @Autowired
    private VehiculeChercheurService vehiculeService;
    @Autowired
    private PlanningItemChercheurService planningItemService;
    @Autowired
    private MoniteurPratiqueChercheurService moniteurPratiqueService;
    @Autowired
    private MoniteurTheoriqueChercheurService moniteurTheoriqueService;
    @Autowired
    private VilleChercheurService villeService;
    @Autowired
    private GerantChercheurService gerantService;
