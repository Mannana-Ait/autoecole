...
@Service
public class MoniteurTheoriqueAdminServiceImpl extends AbstractServiceImpl<MoniteurTheorique> implements MoniteurTheoriqueAdminService {
...
public List<MoniteurTheorique> findAll(){
    ...
    public int deleteByEcoleId(Long id) {
        return moniteurTheoriqueDao.deleteByEcoleId(id);
    }

    @Override
    public List<MoniteurTheorique> findByEcoleId(Long id) {
        return moniteurTheoriqueDao.findByEcoleId(id);
    }
