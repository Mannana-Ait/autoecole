...
@Service
public class MoniteurPratiqueAdminServiceImpl extends AbstractServiceImpl<MoniteurPratique> implements MoniteurPratiqueAdminService {
...
public List<MoniteurPratique> findAll(){
    ...
    public int deleteByEcoleId(Long id) {
        return moniteurPratiqueDao.deleteByEcoleId(id);
    }

    @Override
    public List<MoniteurPratique> findByEcoleId(Long id) {
        return moniteurPratiqueDao.findByEcoleId(id);
    }
