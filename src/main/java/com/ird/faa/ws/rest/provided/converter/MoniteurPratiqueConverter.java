...
@Component
public class MoniteurPratiqueConverter extends AbstractConverter<MoniteurPratique, MoniteurPratiqueVo> {
    ...
    public MoniteurPratiqueConverter() {
        init(true);
    }

    @Override
    public MoniteurPratique toItem(MoniteurPratiqueVo vo) {
        if (vo == null) {
            return null;
        } else {
            MoniteurPratique item = new MoniteurPratique();
    ...
    @Override
    public MoniteurPratiqueVo toVo(MoniteurPratique item) {
        if (item == null) {
            return null;
        } else {
            MoniteurPratiqueVo vo = new MoniteurPratiqueVo();
            if (item.getId() != null)
